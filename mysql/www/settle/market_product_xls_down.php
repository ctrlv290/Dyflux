...
$xls_header = array(
	...
	array(
		"header_name" => "판매금액합",
		"field_name" => "product_option_sale_price",
		"width" => 20,
		"data_type" => "number",
		"halign" => "right",
	),
	...
	array(
		"header_name" => "정산금액",
		"field_name" => "order_calculation_amt",
		"width" => 20,
		"data_type" => "number",
		"halign" => "right",
	),
