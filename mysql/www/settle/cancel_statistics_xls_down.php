...
$_SESSION["XLS_CANCEL_STATISTICS"] = "Y";

//기존 Grid List 불러오기 및 엑셀 출력용 변수 설정
$gridPrintForExcelDownload = true;
require "./cancel_statistics_grid.php";
...
$xls_header = array(
	...
	array(
		"header_name" => "배송전취소",
		"field_name" => "product_cancel_shipped_N",
		"width" => 20,
		"data_type" => "number",
		"halign" => "right",
	),
	array(
		"header_name" => "배송후취소",
		"field_name" => "product_cancel_shipped_Y",
		"width" => 20,
		"data_type" => "number",
		"halign" => "right",
	),
	array(
		"header_name" => "반품-취소(환불)",
		"field_name" => "RETURN_REFUND",
		"width" => 20,
		"data_type" => "number",
		"halign" => "right",
	),
	...
	array(
		"header_name" => "반품-오배송",
		"field_name" => "RETURN_DELIVERY_ERR",
		"width" => 20,
		"data_type" => "number",
		"halign" => "right",
	),
	array(
		"header_name" => "반품-고객변심",
		"field_name" => "RETURN_CUSTOMER_MIND",
		"width" => 20,
		"data_type" => "number",
		"halign" => "right",
	),
	...
	array(
		"header_name" => "취소-배송지연",
		"field_name" => "CANCEL_DELIVERY_DELAY",
		"width" => 20,
		"data_type" => "number",
		"halign" => "right",
	),
...
ob_end_flush();
$_SESSION["XLS_CANCEL_STATISTICS"] = "";
