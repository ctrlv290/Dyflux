					...
					<table>
						...
						foreach($_bank_list as $bank) {
							...
							<tr>
								...
								<td>
									<input type="text" name="tran_in[]" class="w100per <?=$mask_class?>" value="<?=$tran_in != '0' ? $tran_in : ''?>" />
								</td>
								<td>
									<input type="text" name="tran_out[]" class="w100per <?=$mask_class?>" value="<?=$tran_out != '0' ? $tran_out : ''?>" />
								</td>
								<td>
