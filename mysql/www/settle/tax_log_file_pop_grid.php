...
if($tax_type == "PURCHASE"){
	$args['qry_get_colum'] 	.= " 
								...
								, CONCAT(S.supplier_addr1, ' ', S.supplier_addr2) as target_addr 
	...
	$args['qry_get_colum'] 	.= " 
								...
								, CONCAT(V.vendor_addr1, ' ', V.vendor_addr2) as target_addr 
								, V.vendor_officer1_name as officer_name
								, V.vendor_email_order as email
	";
}

$args['qry_table_name'] 	= " DY_SETTLE_TAX_FILE A
...
$args['qry_where']			= " A.file_is_del = 'N' And A.tax_type = N'$tax_type'
";
