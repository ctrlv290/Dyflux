...
$args['qry_get_colum'] 	= " 
							A.seller_idx
							, A.ad_date
							, Case When A.ad_inout = 1 Then ad_amount Else '' End as ad_amount_charge
                            , Case When A.ad_inout = -1 Then ad_amount Else '' End as ad_amount_use
							, A.ad_amount
							, A.ad_product_name
							, A.ad_memo
							, A.ad_regdate 
							, S.seller_name
							, M.member_id
							, DATE_FORMAT(ad_regdate, '%Y-%m-%d %H:%i:%s') as ad_regdate2
";
$args['qry_table_name'] 	= " 
								DY_SETTLE_AD_COST A
