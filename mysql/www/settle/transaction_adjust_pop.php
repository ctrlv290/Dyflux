				...
				<div class="tb_wrap">
					<table autofocus="autofocus">
						...
						<tr>
							...
							<th>수수료</th>
							<td class="text_left">
								<input type="text" name="settle_sale_commission_in_vat" class="w150px onlyNumber" value="0" tabindex="9" />
							</td>
						</tr>
						<tr>
							<th>공급가액</th><!--매출공급가액-->
							...
							<th>공급가액</th><!--판매수수료-->
							<td class="text_left">
								<input type="text" name="settle_sale_commission_ex_vat" class="w150px onlyNumber" value="0" tabindex="10" />
							</td>
						</tr>
						<tr>
							...
							<th>수수료</th>
							<td class="text_left">
								<input type="text" name="settle_delivery_commission_in_vat" class="w150px onlyNumber" value="0" tabindex="13" />
							</td>
						</tr>
						<tr>
							<th>공급가액</th><!--배송비-->
							...
							<td class="text_left">
								<input type="text" name="settle_delivery_commission_ex_vat" class="w150px onlyNumber" value="0" tabindex="14" />
							</td>
						</tr>
						<tr>
