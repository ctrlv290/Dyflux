	...
	<div class="content">
			...
			<div class="find_wrap">
				<div class="finder">
					<div class="finder_set">
						...
						<div class="finder_col">
							<input type="text" name="supplier_name" class="w200px enterDoSearch" placeholder="공급처명" />
						</div>
					</div>
				</div>
				<div class="find_btn">
		...
		<div class="grid_btn_set_top">
			...
			<div class="right">
				...
				<a href="javascript:;" class="btn green_btn btn-supplier-xls-down">다운로드</a>
			</div>
		</div>
...
<script>
	window.name = 'supplier_list';
	Supplier.SupplierListInit();
