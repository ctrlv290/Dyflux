				...
				<div class="finder">
					<div class="finder_set">
                        ...
                        <div class="finder_col">
                            ...
                            <select name="comm_type" class="comm_type" data-selected="<?=$comm_type?>">
...
<!--                                <option value="market_product_no" -->
<!--                                    --><?//=($search_column == "market_product_no") ? "selected" : ""?>
<!--                                >판매처 상품코드</option>-->
...
<script src="/js/page/product.product.commission.js?v=200325"></script>
<script>
