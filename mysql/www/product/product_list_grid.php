...
$args['qry_get_colum'] 	= " A.product_idx
							...
							, A.product_name
							, IFNULL((Select name From DY_CATEGORY C Where C.category_idx = A.product_category_l_idx), '') as category_l_name, A.product_category_l_idx 
							, IFNULL((Select name From DY_CATEGORY C Where C.category_idx = A.product_category_m_idx), '') as category_m_name, A.product_category_m_idx
