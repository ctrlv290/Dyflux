...
<div class="container">
	...
	<div class="content">
					...
					<div class="finder_set">
						...
						<div class="finder_col">
							<select name="search_column">
								...
								<option value="O.product_option_idx" <?=($search_column == "O.product_option_idx") ? "selected" : ""?>>옵션코드</option>
							</select>
		...
		<div class="grid_btn_set_top">
			<span>&nbsp;</span>
			<div class="right">
                <a href="javascript:;" class="btn red_btn btn-product-matching-multi-delete">선택삭제</a>
...
<script src="/js/page/product.product.matching.js?v=191216"></script>
<script>
	window.name = 'product_matching_list';
	ProductMatching.ProductMatchingListInit();
</script>
