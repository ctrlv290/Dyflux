	...
	<div class="content write_page">
		<div class="content_wrap w800px">
			<form name="dyForm" method="post" class="<?php echo $mode?>">
				...
				<div class="btn_set">
					<div class="center">
						<a href="work_write.php?ref_idx=<?=$_view["bbs_idx"]?>&<?=$page_parameters?>" class="large_btn green_btn ">답글</a>
						<?php if($canModify){?>
							<a href="work_write.php?bbs_id=<?=$bbs_id?>&bbs_idx=<?=$bbs_idx?>&<?=$page_parameters?>" id="btn-save" class="large_btn blue_btn ">수정</a>
						<?php }?>
						<a href="work_list.php?<?=$page_parameters?>" class="large_btn">목록</a>
