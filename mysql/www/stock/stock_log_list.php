...
<div class="container">
	...
	<div class="content">
		<form name="searchForm" id="searchForm" method="get">
			<div class="find_wrap">
				<div class="finder">
					...
					<div class="finder_set">
						<div class="finder_col">
							<span class="text">작업 전 상태</span>
							<select name="stock_status_prev">
								<option value="">전체</option>
								<?php
								foreach($GL_controlStockFromAbleStatusList as $key => $val){
						...
						<div class="finder_col">
							<span class="text">작업 후 상태</span>
							<select name="stock_status_next">
								<option value="">전체</option>
								<?php
								foreach($GL_controlStockToAbleStatusList as $key => $val){
									echo '<option value="'.$key.'">'.$val.'</option>';
								}
								?>
							</select>
		...
		<div class="grid_btn_set_top">
			<span>&nbsp;</span>
			<div class="right">
				<a href="javascript:;" class="btn green_btn btn-stock-log-xls-down">다운로드</a>
			</div>
		</div>
...
<script src="/js/page/stock.log.js"></script>
