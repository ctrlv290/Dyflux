...
$xls_header = array(
	...
	array(
		"header_name" => "처리 전 상태",
		"field_name" => "stock_status_prev_han",
		"width" => 14,
	),
	array(
		"header_name" => "처리 후 상태",
		"field_name" => "stock_status_next_han",
		"width" => 18,
	),
	array(
		"header_name" => "수량",
		"field_name" => "stock_move_amount",
		"width" => 10,
	),
	array(
		"header_name" => "원가(매입가)",
...
foreach($_list as $row_num => $row) {
	...
	foreach ($xls_row as $cellValue) {
		$activesheet->setCellValueExplicit(getNameFromNumber($currentColumn).$i, $cellValue,
