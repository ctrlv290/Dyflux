...
$order_by = "stock_move_regdate DESC";
...
if($_search_param)
{
	...
	foreach($_search_paramAry as $sitem) {
		...
		if(trim($val) && in_array($col, $avaliable_col)) {
			if(
				...
				|| $col == "stock_status_prev"
				|| $col == "stock_status_next"
			) {
	...
	if($_search_paramAryList["date_start"] != "" && $_search_paramAryList["date_end"] != ""){
		$qryWhereAry[] = "	 
			stock_move_regdate >= '".$_search_paramAryList["date_start"]." 00:00:00' 
...
// make select query
$args['qry_table_idx'] 	= "A.stock_move_idx";
...
$args['qry_table_name'] 	= " DY_STOCK_MOVE_LOG A 
...
";
$args['qry_where']			= " A.stock_move_is_del = N'N' ";
