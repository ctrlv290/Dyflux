...
$order_by = "A.stock_order_email_regdate DESC";
...
if($_search_param)
{
	...
	if($_search_paramAryList["date_start"] != "" && $_search_paramAryList["date_end"] != ""){
		$qryWhereAry[] = "	 
			A.stock_order_email_regdate >= '".$_search_paramAryList["date_start"]." 00:00:00' 
			And A.stock_order_email_regdate <= '".$_search_paramAryList["date_end"]." 23:59:59' 
		";
	}
...
// make select query
$args['qry_table_idx'] 	= "A.stock_order_email_idx";
...
$args['qry_table_name'] 	= " DY_STOCK_ORDER_EMAIL A
...
";
$args['qry_where']			= " A.stock_order_email_is_del = 'N' 
";
