...
$args['qry_get_colum'] 	= " A.seller_idx, A.seller_name
							, (Select collect_sdate From DY_ORDER_COLLECT C Where C.seller_idx = A.seller_idx Order by order_collect_idx desc LIMIT 1)  as last_order_datetime
							, (Select collect_count From DY_ORDER_COLLECT C Where C.seller_idx = A.seller_idx Order by order_collect_idx desc LIMIT 1)  as last_order_count
							, (Select collect_order_count From DY_ORDER_COLLECT C Where C.seller_idx = A.seller_idx Order by order_collect_idx desc LIMIT 1)  as last_new_order_count
							, (
