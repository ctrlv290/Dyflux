 ...
 * User: woox
 * Date: 2018-11-01
 * Desc: 내정보 수정 - 벤더사 Include (from myinfo.php)
 */
					...
					<table>
						...
						<tr>
							...
							<td class="text_left">
								...
								<input type="hidden" name="vendor_startdate" value="<?=$vendor_startdate?>" />
								&nbsp;&nbsp;
								거래종료일 : <?=$vendor_startdate?>
								<input type="hidden" name="vendor_enddate" value="<?=$vendor_startdate?>" />
							</td>
						</tr>
						<tr>
