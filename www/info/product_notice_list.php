				...
				<div class="finder">
					<div class="finder_set">
						<div class="finder_col">
							<input type="text" name="product_notice_title" class="w200px enterDoSearch" placeholder="상품정보제공고시 명" />
						</div>
					</div>
				</div>
				<div class="find_btn">
...
<script>
	window.name = "product_notice_list";
	ProductNotice.ProductNoticeListInit();
</script>
