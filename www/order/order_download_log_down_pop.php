						...
						<div class="finder_set">
							...
							<div class="finder_col">
								<select name="search_column">
									<option value="order_download_email_receiver" <?=($search_column == "order_download_email_receiver") ? "selected" : ""?>>수신자</option>
...
<script>
	...
	OrderShipped.OrderDownloadLogDownInit();
</script>
