 ...
 * User: woox
 * Date: 2018-11-01
 * Desc: 주문다운로드 이메일 발송 로그 리스트 JSON
 */
//Page Info
$pageMenuIdx = 220;
//Init
...
$order_by = "A.order_download_email_regdate DESC";
...
if($_search_param)
{
	...
	if($_search_paramAryList["date_start"] != "" && $_search_paramAryList["date_end"] != ""){
		$qryWhereAry[] = "	 
			A.order_download_email_regdate >= '".$_search_paramAryList["date_start"]." 00:00:00' 
			And A.order_download_email_regdate <= '".$_search_paramAryList["date_end"]." 23:59:59' 
		";
	}
...
// make select query
$args['qry_table_idx'] 	= "A.order_download_email_idx";
$args['qry_get_colum'] 	= " A.*
							, S.supplier_name
							, M.member_id
                            ";

$args['qry_table_name'] 	= " DY_ORDER_DOWNLOAD_EMAIL A
...
";
$args['qry_where']			= " A.order_download_email_is_del = 'N' 
";
