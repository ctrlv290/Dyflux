...
$args['qry_get_colum'] 	= " 
							...
							, Convert(varchar(30), order_progress_step_accept_date, 120) as order_progress_step_accept_date2
                            ";
...
foreach($_list as $row_num => $row) {
	...
	foreach ($xls_row as $cellValue) {
		...
		if($inner_no > 1) {
			if ($field_name == "order_idx" || $field_name == "order_progress_step_accept_date2" || $field_name == "seller_name") {
				$cellValue = "";
			}
		}
