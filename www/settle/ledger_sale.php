	...
	<div class="content">
		...
		<div class="btn_set top_btn_set dis_none">
			...
			<div class="right">
				...
				<a href="javascript:;" class="btn btn-ledger-detail-add" data-type="TRAN">실입금액 등록</a>
				<a href="javascript:;" class="btn btn-ledger-detail-add" data-type="REFUND">공제/환급액 등록</a>
				<a href="javascript:;" class="btn btn-ledger-detail-add" data-type="ADJUST">매출 추가 등록</a>
				<a href="javascript:;" class="btn green_btn btn-ledger-all-down btn-ledger-create-xls" data-month_start="" data-month_end="" data-target_idx="" data-type="LEDGER_SALE">다운로드</a>
...
<script>
	window.name = 'settle_sale_ledge';
	SettleLedge.SaleLedgeInit();
</script>
