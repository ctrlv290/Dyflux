...
if($mode == "get_sale_credit") {
	...
	$_list              = $C_SETTLE->getTransactionStateSaleCredit($period_type, $date, "Y");
	$response["result"] = true;
	$response["data"]   = $_list;
}elseif($mode == "get_purchase_credit") {
	...
	$_list              = $C_SETTLE->getTransactionStatePurchaseCredit($period_type, $date, "N");
	$response["result"] = true;
	$response["data"]   = $_list;
	...
	$_list              = $C_SETTLE->getTransactionStatePurchaseCredit($period_type, $date, "Y");
	$response["result"] = true;
	$response["data"]   = $_list;
