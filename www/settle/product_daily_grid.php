...
$args['qry_get_colum'] 	.= "
							...
							, CURRENT_ORDER_ACCEPT.current_accept_count
							, CURRENT_ORDER_INVOICE.current_invoice_count
                            ";
...
$args['qry_table_name'] 	.= " 
									...
									From 
										...
										Group by product_idx, product_option_idx, product_option_purchase_price, settle_date
									) as SETTLE
									On DateTable.value = SETTLE.settle_date
								...
								Left Outer Join (								
									Select 
										sum(product_option_cnt) as current_accept_count
										, MM_A.product_option_idx
									From DY_ORDER OO_A
									...
									Group By MM_A.product_option_idx
									
								) as CURRENT_ORDER_ACCEPT
								On STOCK_DAILY.product_option_idx = CURRENT_ORDER_ACCEPT.product_option_idx
								
								Left Outer Join (								
									Select 
										sum(product_option_cnt) as current_invoice_count
										, MM_A.product_option_idx
									From DY_ORDER OO_A
									Inner Join DY_ORDER_PRODUCT_MATCHING MM_A
										On OO_A.order_idx = MM_A.order_idx
								...
								) as CURRENT_ORDER_INVOICE
								On STOCK_DAILY.product_option_idx = CURRENT_ORDER_INVOICE.product_option_idx
