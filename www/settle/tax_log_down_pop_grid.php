...
$args['qry_table_name'] 	= " 
								DY_SETTLE_TAX_FILE_DOWN_LOG A
								Left Outer Join DY_SETTLE_TAX_EMAIL E On A.email_idx = E.email_idx
...
$args['qry_where']			= " 1=1 And F.tax_type = N'$tax_type' ";
