...
$_list_sale_credit = $C_SETTLE->getTransactionStateSaleCredit($period, $date, "N");
...
$_list_sale_prepay = $C_SETTLE->getTransactionStateSaleCredit($period, $date, "Y");
...
$_list_purchase_credit = $C_SETTLE->getTransactionStatePurchaseCredit($period, $date, "N");
$_list_set_ary[] = array("type" => "PURCHASE_CREDIT_IN_AMOUNT", "title" => "매입현황(외상매입금)" , "list" => $_list_purchase_credit, "PREV" => "미지급금액", "TOTAL" => "매입합계", "TRAN" => "송금액");
...
$_list_purchase_prepay = $C_SETTLE->getTransactionStatePurchaseCredit($period, $date, "Y");
