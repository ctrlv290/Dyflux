...
$_SESSION["XLS_SALE_PROFIT_PERIOD"] = "Y";
...
if($date_year && $date_month){
	$_list = $C_Settle -> getSalesProfitByPeriod($date_year, $date_month, $seller_idx);
}
	...
	foreach ($xls_row as $cellValue) {
		...
		if($field_name == "settle_sale_supply_vat"){
			...
			if($seller_name == ""){
				...
				$totalRowRangeCod = getNameFromNumber(0) . $i . ":" . getNameFromNumber(8) . $i;
...
ob_end_flush();
$_SESSION["XLS_SALE_PROFIT_PERIOD"] = "";
