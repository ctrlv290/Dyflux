	...
	var SupplierXlsWriteGridInit = function(){
		...
		if(xlsWritePageMode == "add")
		{
			...
			colModel = [
				...
				{ label: '사용여부', name: 'R', index: 'is_use', width: 150, sortable: false},
			...
			colModel = [
				...
				{ label: '등급', name: 'C', index: 'supplier_grade', width: 80, sortable: false},
				{ label: '로그인<br>비밀번호', name: 'D', index: 'member_pw', width: 150, sortable: false},
				{ label: '대표이사', name: 'E', index: 'supplier_ceo', width: 150, sortable: false},
				{ label: '사업자<br>등록번호', name: 'F', index: 'supplier_license_number', width: 150, sortable: false},
				{ label: '담당자', name: 'G', index: 'supplier_officer1_name', width: 150, sortable: false},
				{ label: '연락처', name: 'H', index: 'supplier_officer1_tel', width: 150, sortable: false},
				{ label: '휴대폰번호', name: 'I', index: 'supplier_officer1_mobile', width: 150, sortable: false},
				{ label: '이메일', name: 'J', index: 'supplier_officer1_email', width: 150, sortable: false},
				{ label: '주소<br>우편번호', name: 'K', index: 'supplier_zipcode', width: 150, sortable: false},
				{ label: '주소<br>기본주소', name: 'L', index: 'supplier_addr1', width: 150, sortable: false},
				{ label: '주소<br>상세주소', name: 'M', index: 'supplier_addr2', width: 150, sortable: false},
				{ label: 'MD', name: 'N', index: 'supplier_md', width: 150, sortable: false},
				{ label: '계좌번호', name: 'O', index: 'supplier_bank_account_number', width: 150, sortable: false},
				{ label: '은행', name: 'P', index: 'supplier_bank_name', width: 150, sortable: false},
				{ label: '예금주', name: 'Q', index: 'supplier_bank_holder_name', width: 150, sortable: false},
				{ label: '비고', name: 'R', index: 'supplier_etc', width: 150, sortable: false},
				{ label: '사용여부', name: 'S', index: 'is_use', width: 150, sortable: false},
				{ label: '비고', name: 'valid', index: 'valid', width: 150, sortable: false
					, formatter: function(cellvalue, options, rowobject){
						var rst;
						if(cellvalue)
