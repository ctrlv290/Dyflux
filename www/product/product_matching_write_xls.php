...
$mode = "add";
$xls_type = "product_matching_regist";
$_sample_filename = "매칭_일괄_등록_엑셀.xlsx";
//일괄수정
if($_GET["mode"] == "delete")
{
	//Page Info
	...
	$mode = "delete";
	$xls_type = "product_matching_delete";
	$_sample_filename = "매칭_일괄_삭제_엑셀.xlsx";
}
...
<div class="container">
	...
	<div class="content">
		<form name="searchForm" id="searchForm" method="post" enctype="multipart/form-data" action="/proc/_xls_upload.php" target="xls_hidden_frame">
			...
			<input type="hidden" name="xls_type" value="<?=$xls_type?>" />
			<div class="find_wrap">
				<div class="finder">
		...
		<?php if($mode == "mod"){?>
			<p class="info_txt col_red">수정하려는 벤더사코드가 맞지 않는 경우 수정되지 않습니다.</p>
		<?php }?>
...
<script>
	ProductMatching.ProductMatchingXlsWriteInit();
</script>
