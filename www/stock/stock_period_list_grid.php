...
$args['qry_table_name'] 	= " 
								...
								Left Outer Join (
									Select 
										product_idx, product_option_idx, stock_unit_price
										, isNull(Sum(Case When stock_status = 'NORMAL' Then stock_amount * stock_type Else 0 End), 0) as stock_amount_NORMAL_last
										, isNull(Sum(Case When stock_status = 'BAD' Then stock_amount * stock_type Else 0 End), 0) as stock_amount_BAD_last
									From DY_STOCK ST2
										Where stock_is_del = N'N' And stock_is_confirm = N'Y'
										$_searchWhereStockProcDateLast
										Group by product_idx, product_option_idx, stock_unit_price
