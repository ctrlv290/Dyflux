...
$xls_header = array(
	...
	array(
		"header_name" => "상태",
		"field_name" => "delivery_status_han",
		"width" => 12,
	),
	array(
		"header_name" => "사이트결제-예정",
		"field_name" => "pay_site",
		"width" => 20,
		"data_type" => "number",
		"halign" => "right",
	...
	array(
		"header_name" => "사이트결제-도착",
		"field_name" => "paid_site",
		"width" => 20,
		"data_type" => "number",
		"halign" => "right",
	),
