...
$_SESSION["XLS_SELLER_CANCEL_OFF_LIST"] = "Y";

//기존 Grid List 불러오기 및 엑셀 출력용 변수 설정
$gridPrintForExcelDownload = true;
require "./seller_cancel_off_list_grid.php";
...
$xls_header = array(
	...
	array(
		"header_name" => "취소일",
		"field_name" => "order_seller_cancel_date",
		"width" => 24
	),
	array(
		"header_name" => "취소철회접수일",
		"field_name" => "order_seller_cancel_off_date",
		"width" => 24
	),
	array(
		"header_name" => "작업",
		"field_name" => "order_seller_cancel_confirm",
		"width" => 12,
	),
);
...
ob_end_flush();
$_SESSION["XLS_SELLER_CANCEL_OFF_LIST"] = "";
