...
$_SESSION["XLS_SELLER_CANCEL_LIST"] = "Y";

//기존 Grid List 불러오기 및 엑셀 출력용 변수 설정
$gridPrintForExcelDownload = true;
require "./seller_cancel_list_grid.php";
...
$xls_header = array(
	...
	array(
		"header_name" => "메모",
		"field_name" => "order_seller_cancel_reason",
		"width" => 60,
		"halign" => "left",
	),
	array(
...
ob_end_flush();
$_SESSION["XLS_SELLER_CANCEL_LIST"] = "";
