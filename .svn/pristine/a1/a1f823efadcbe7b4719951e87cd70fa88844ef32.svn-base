			...
			<div class="find_wrap">
				<div class="finder">
					<div class="finder_set">
						...
						<div class="finder_col">
							<input type="text" name="nameidip" class="w200px enterDoSearch" placeholder="이름 또는 아이디 또는 아이피" />
						</div>
					</div>
				</div>
				<div class="find_btn">
...
<script src="/js/page/info.member.login.log.js"></script>
<script>
	MemberLoginLog.LoginLogListInit();
</script>
