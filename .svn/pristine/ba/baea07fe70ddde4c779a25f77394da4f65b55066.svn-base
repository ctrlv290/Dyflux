...
$order_by = "A.order_download_file_down_regdate DESC";
...
if($_search_param)
{
	...
	if($_search_paramAryList["date_start"] != "" && $_search_paramAryList["date_end"] != ""){
		$qryWhereAry[] = "	 
			A.order_download_file_down_regdate >= '".$_search_paramAryList["date_start"]." 00:00:00' 
			And A.order_download_file_down_regdate <= '".$_search_paramAryList["date_end"]." 23:59:59' 
		";
	}
...
// make select query
$args['qry_table_idx'] 	= "A.order_download_file_down_idx";
$args['qry_get_colum'] 	= " A.*
							, E.order_download_email_receiver
							, E.order_download_email_title
							, S.supplier_name
                            ";

$args['qry_table_name'] 	= " 
								DY_ORDER_DOWNLOAD_FILE_DOWN_LOG A
								Left Outer Join DY_ORDER_DOWNLOAD_EMAIL E On A.order_download_email_idx = E.order_download_email_idx
