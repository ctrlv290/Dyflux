					...
					<div class="finder_set">
						<div class="finder_col">
							<select name="search_column">
								<option value="R.receive_name">수령자</option>
								<option value="R.receive_tp_num">수령자 전화</option>
								<option value="R.receive_hp_num">수령자 핸드폰</option>
								<option value="R.receive_addr1">주소</option>
								...
								<option value="R.order_idx">관리번호</option>
							</select>
...
<script src="/js/page/cs.return.js?v=200316"></script>
