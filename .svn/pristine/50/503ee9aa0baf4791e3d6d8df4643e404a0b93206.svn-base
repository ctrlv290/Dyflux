		...
		$.ajax({
			...
			if(response)
			{
				$.each(response.data, function(i, o){
					...
					var cnt_cancel_after_shipped = parseInt(o.cnt_cancel_after_shipped);
					var cnt_change_after_shipped = parseInt(o.cnt_change_after_shipped);
		...
		$.ajax({
			...
			if(response)
			{
				$.each(response.data, function(i, o){
					...
					var C_SUM = parseInt(C_RETURN_REFUND) + parseInt(C_RETURN_POOR) + parseInt(C_RETURN_DELIVERY_ERR) + parseInt(C_CANCEL_LOSS) + parseInt(C_CANCEL_SOLDOUT) + parseInt(C_CANCEL_DELIVERY_DELAY);
					...
					var X_SUM = parseInt(X_EXCHANGE_NORMAL) + parseInt(X_EXCHANGE_POOR) + parseInt(X_EXCHANGE_DELIVERY_ERR) + parseInt(X_EXCHANGE_SOLDOUT) + parseInt(X_EXCHANGE_PRODUCT_CHANGE);
					var NORMAL = o.NORMAL;
					var SUM = NORMAL;
