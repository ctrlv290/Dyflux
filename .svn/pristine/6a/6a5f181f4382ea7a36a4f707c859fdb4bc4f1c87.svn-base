...
<?php include_once DY_Mobile_INCLUDE_PATH . "/_include_header.php"; ?>
					...
					<div class="form_sale_set">
						...
						<div class="page_line sellers">
							...
							<span class="select_set">
								...
								<select name="seller_idx" id="seller_idx" class="seller_idx w100px" data-selected="0" data-default-value="" data-default-text="판매처 선택">
								</select>
							</span>
						</div>
					</div>
	...
	<script src="../js/seller.sale.js"></script>
