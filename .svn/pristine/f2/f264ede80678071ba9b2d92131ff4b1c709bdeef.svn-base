			...
			<form name="searchForm" id="searchForm" method="get">
				...
				<div class="find_wrap">
					<div class="finder">
						...
						<div class="finder_set">
							<?php if($ledger_type == "LEDGER_PURCHASE"){?>
								<div class="finder_col">
							...
							<div class="finder_col">
								<select name="search_column">
									<option value="email_receiver" <?=($search_column == "email_receiver") ? "selected" : ""?>>수신자</option>
...
<script>
	...
	SettleLedge.LedgerLogDownInit('<?=$ledger_type?>');
</script>
