				...
				<div class="finder">
					...
					<div class="finder_set">
                        ...
                        <div class="finder_col">
                            ...
                            <select name="product_sale_type">
                                <option value="">전체</option>
                                <option value="SELF">사입</option>
...
<script src="/js/column_const.js?v=200525"></script>
<script src="/common/column_load_js.php?target=ORDER_SEARCH_LIST"></script>
<script src="/js/page/order.order.js?v=200525"></script>
<script>
