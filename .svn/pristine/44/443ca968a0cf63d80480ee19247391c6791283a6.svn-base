	...
	<div class="content write_page">
		<div class="content_wrap">
			...
			<div class="btn_set">
				<span>&nbsp;</span>
				<div class="right">
					<a href="javascript:;" class="btn btn-send-email-selected" id="btn-send-email-selected">선택 이메일발송</a>
				</div>
			</div>
			<br>
...
<script>
	...
	SettleLedge.LedgerLogFileInit("<?=$ledger_type?>");
</script>
