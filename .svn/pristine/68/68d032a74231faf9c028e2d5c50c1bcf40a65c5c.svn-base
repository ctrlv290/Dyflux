...
$_SESSION["XLS_PRODUCT_TRASH_LIST"] = "Y";

//기존 Grid List 불러오기 및 엑셀 출력용 변수 설정
$gridPrintForExcelDownload = true;
require "./product_trash_list_grid.php";
...
$xls_header = array(
	array(
		"header_name" => "삭제일",
		"field_name" => "product_is_trash_date2",
		"width" => 30,
	),
	array(
		"header_name" => "상품코드",
	...
	array(
		"header_name" => "판매타입",
		"field_name" => "product_sale_type",
		"width" => 18,
		"halign" => "left",
	),
	array(
		"header_name" => "카테고리1",
		"field_name" => "category_l_name",
		"width" => 40,
		"halign" => "left",
	),
	array(
		"header_name" => "카테고리2",
		"field_name" => "category_m_name",
		"width" => 40,
		"halign" => "left",
	),
	array(
	...
	array(
		"header_name" => "공급처상품명",
		"field_name" => "product_supplier_name",
		"width" => 60,
		"halign" => "left",
	),
	array(
		"header_name" => "등록일",
		"field_name" => "product_regdate2",
		"width" => 22,
	),
	array(
		"header_name" => "벤더사노출",
		"field_name" => "product_vendor_show",
		"width" => 12,
	),
);
...
ob_end_flush();
$_SESSION["XLS_PRODUCT_TRASH_LIST"] = "";
