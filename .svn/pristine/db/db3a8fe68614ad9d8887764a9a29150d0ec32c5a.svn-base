	...
	<div class="content write_page">
		<div class="content_wrap">
			...
			<div class="btn_set">
				<span>&nbsp;</span>
				<div class="right">
					<a href="javascript:;" class="btn green_btn btn-send-email-selected">선택 이메일 발송</a>
				</div>
			</div>
...
<script src="/js/page/order.shipped.js?v=200506"></script>
<script>
	window.name = "stock_order_log_file";
	OrderShipped.OrderDownloadLogFileInit();
</script>
