...
$args['qry_get_colum'] 	= "
							...
							, Case When STOCK.stock_amount_NORMAL is null Then OPM.product_option_cnt
								Else
									isNull(OPM.product_option_cnt - STOCK.stock_amount_NORMAL, 0)
								End  AS shortage_cnt
...
$args['qry_where']			= " 
								...
								And ( 
									OPM.product_option_cnt > STOCK.stock_amount_NORMAL
									Or STOCK.product_option_idx is null
								)
";
