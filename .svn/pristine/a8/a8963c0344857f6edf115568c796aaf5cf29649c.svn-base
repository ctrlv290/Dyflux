...
if($mode == "add") {
	...
	$idx = $C_Loan->insertLoanAccount($loan_name, $loan_amount, $loan_detail, $loan_sort, $loan_is_use);
	...
	$idx = $C_Loan->updateLoanAccount($loan_idx, $loan_name, $loan_amount, $loan_detail, $loan_is_use);
