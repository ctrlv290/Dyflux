...
$args['qry_table_name'] 	.= " 
									...
									Select 
										...
										, convert(varchar(7), settle_date, 120) as settle_date
									From 
										(
											Select *
											From DY_SETTLE 
										...
										Group by product_idx, product_option_idx, product_option_purchase_price, convert(varchar(7), settle_date, 120)
									) as SETTLE
