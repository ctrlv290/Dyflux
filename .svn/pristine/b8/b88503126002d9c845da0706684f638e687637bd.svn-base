...
<div class="container">
	...
	<div class="content write_page">
		<div class="content_wrap">
			<form name="dyForm" id="dyForm" method="post" class="<?=$mode?>" action="banner_proc.php" enctype="multipart/form-data">
				...
				<table>
					...
					<tr>
						...
						<td class="text_left">
							...
							<br>
							<span class="info_txt col_red">배너 사이즈 : 1200px x 400px</span><br>
			...
			<div class="btn_set">
				<div class="center">
					...
					<a href="javascript:history.back();" class="large_btn red_btn btn-common-pop-close">취소</a>
				</div>
			</div>
		</form>
		</div>
