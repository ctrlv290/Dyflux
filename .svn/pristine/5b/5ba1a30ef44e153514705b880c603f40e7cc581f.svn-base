				...
				<div class="finder">
					<div class="finder_set">
                        ...
                        <div class="finder_col">
                            ...
                            <select name="stock_kind" class="stock_is_proc" data-selected="<?=$stock_kind?>">
                                <option value="">전체</option>
...
<!--                                <option value="EXCHANGE">교환</option>-->
					...
					<div class="finder_set">
						...
						<div class="finder_col">
							<select name="search_column">
								...
								<option value="stock_order_idx" <?=($search_column == "A.stock_order_idx") ? "selected" : ""?>>발주코드</option>
		...
		<div class="grid_btn_set_top">
			...
			<div class="right">
				...
				<a href="javascript:;" class="btn green_btn btn-stock-due-xls-down">다운로드</a>
			</div>
		</div>
