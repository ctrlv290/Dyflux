...
$args['qry_table_name'] 	= " 
								...
								, isNull(Sum(Case When order_cs_status = 'ORDER_CANCEL' Then product_option_cnt End), 0) as cancel_cnt 
								, isNull(Sum(Case When order_cs_status = 'ORDER_CANCEL' And product_cancel_shipped = 'N' Then product_option_cnt End), 0) as product_cancel_shipped_N
								, isNull(Sum(Case When order_cs_status = 'ORDER_CANCEL' And product_cancel_shipped = 'Y' Then product_option_cnt End), 0) as product_cancel_shipped_Y
								, isNull(Sum(Case When order_cs_status = 'ORDER_CANCEL' And cs_reason_code1 = 'CS_REASON_CANCEL' And cs_reason_code2 = 'RETURN_REFUND' Then product_option_cnt End), 0) as RETURN_REFUND
								, isNull(Sum(Case When order_cs_status = 'ORDER_CANCEL' And cs_reason_code1 = 'CS_REASON_CANCEL' And cs_reason_code2 = 'RETURN_POOR' Then product_option_cnt End), 0) as RETURN_POOR
								, isNull(Sum(Case When order_cs_status = 'ORDER_CANCEL' And cs_reason_code1 = 'CS_REASON_CANCEL' And cs_reason_code2 = 'RETURN_DELIVERY_ERR' Then product_option_cnt End), 0) as RETURN_DELIVERY_ERR
								, isNull(Sum(Case When order_cs_status = 'ORDER_CANCEL' And cs_reason_code1 = 'CS_REASON_CANCEL' And cs_reason_code2 = 'CANCEL_LOSS' Then product_option_cnt End), 0) as CANCEL_LOSS
								, isNull(Sum(Case When order_cs_status = 'ORDER_CANCEL' And cs_reason_code1 = 'CS_REASON_CANCEL' And cs_reason_code2 = 'CANCEL_SOLDOUT' Then product_option_cnt End), 0) as CANCEL_SOLDOUT
								, isNull(Sum(Case When order_cs_status = 'ORDER_CANCEL' And cs_reason_code1 = 'CS_REASON_CANCEL' And cs_reason_code2 = 'CANCEL_DELIVERY_DELAY' Then product_option_cnt End), 0) as CANCEL_DELIVERY_DELAY
								, isNull(Sum(Case When order_cs_status = 'ORDER_CANCEL' And cs_reason_code1 = 'CS_REASON_CANCEL' And cs_reason_code2 = 'RETURN_CUSTOMER_MIND' Then product_option_cnt End), 0) as RETURN_CUSTOMER_MIND
								, isNull(Sum(Case When order_cs_status = 'ORDER_CANCEL' And cs_reason_code1 = 'CS_REASON_CANCEL' And cs_reason_code2 = '' Then product_option_cnt End), 0) as ETC
								From 
								DY_ORDER O
