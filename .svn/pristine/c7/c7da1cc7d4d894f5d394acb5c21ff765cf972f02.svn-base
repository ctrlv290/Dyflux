...
$args['qry_get_colum'] 	= " 
							...
							, isnull(SUBSTRING(
							    (
							        SELECT ','+MU.name+' 확인함 ['+convert(varchar(20), stock_due_delay_confirm_regdate, 120)+']'  AS [text()]
							        ...
							        ORDER BY SC.stock_due_delay_confirm_regdate ASC
							        FOR XML PATH ('')
							    ), 2, 3000), '') as 'confirm_list'
