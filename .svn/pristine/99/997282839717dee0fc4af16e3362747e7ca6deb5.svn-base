...
if($_search_param)
{
    ...
    if(!empty($_search_paramAryList["date_start"]) && !empty($_search_paramAryList["date_end"])) {
        $qryWhereAry[] = "	 
			A.tp_regdate >= '".$_search_paramAryList["date_start"]." 00:00:00'
			And A.tp_regdate <= '".$_search_paramAryList["date_end"]." 23:59:59'
		";
    }
}
...
$args['qry_get_colum'] 	= " * ";
$args['qry_table_name'] 	= " DY_SMS_AL_SETUP ";
$args['qry_where']			= "  tp_is_del = N'N' ";
