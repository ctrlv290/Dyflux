...
//								}
//								?>
                                <option value="NORMAL" <?=($stock_status == "NORMAL") ? "selected" : ""?>>정상재고</option>
                                <option value="ABNORMAL" <?=($stock_status == "ABNORMAL") ? "selected" : ""?>>양품재고</option>
                                <option value="BAD" <?=($stock_status == "BAD") ? "selected" : ""?>>불량재고</option>
                                <option value="LOSS" <?=($stock_status == "LOSS") ? "selected" : ""?>>분실재고</option>
                                <option value="DISPOSAL" <?=($stock_status == "DISPOSAL") ? "selected" : ""?>>일반폐기</option>
                                <option value="DISPOSAL_PERMANENT" <?=($stock_status == "DISPOSAL_PERMANENT") ? "selected" : ""?>>영구폐기</option>
                                <option value="HOLD" <?=($stock_status == "HOLD") ? "selected" : ""?>>보류</option>
							</select>
						</div>
						<div class="finder_col">
					...
					<div class="finder_set">
						...
						<div class="finder_col">
							<select name="search_column">
                                <option value="product_name_option_name" <?=($search_column == "product_name_option_name") ? "selected" : ""?>>전체</option>
...
<script src="/js/page/stock.product.js?v=200525"></script>
