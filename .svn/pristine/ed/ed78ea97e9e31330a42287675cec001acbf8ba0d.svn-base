...
var SettlePurchase = (function() {
	...
	var TransactionStateSearch = function(){
		...
		TransactionStateGetTableData(".sale-prepay-n", "get_sale_prepay_n", "SALE_CREDIT_IN_AMOUNT");

		TransactionStateGetTableData(".purchase-credit-type-m", "get_purchase_credit_type_m", "PURCHASE_CREDIT_IN_AMOUNT");
		TransactionStateGetTableData(".purchase-credit-type-d", "get_purchase_credit_type_d", "PURCHASE_CREDIT_IN_AMOUNT");
