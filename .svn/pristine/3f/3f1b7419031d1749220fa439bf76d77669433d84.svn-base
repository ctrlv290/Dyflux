...
<div class="container">
	...
	<div class="content">
		...
		-->
		<p class="info_txt col_red">주의 : 해당 배송정보를 취소하시면 복구가 불가능하므로 주의하시기 바랍니다. </p>
		<div class="grid_btn_set_top">
			<a href="javascript:;" class="large_btn red_btn btn-order-shipped-cancel-all">&nbsp;&nbsp;&nbsp;배송취소&nbsp;&nbsp;&nbsp;</a>
			<div class="right">
			</div>
		</div>
...
<script>
	window.name = 'order_shipped_cancel_view';
	OrderShipped.OrderShippedCancelViewInit();
</script>
