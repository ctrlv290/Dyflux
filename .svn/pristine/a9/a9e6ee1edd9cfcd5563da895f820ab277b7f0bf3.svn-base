...
<div class="container">
	...
	<div class="content">
				...
				<div class="finder">
					<div class="finder_set">
						<div class="finder_col">
							<input type="text" name="nameidx" class="w200px enterDoSearch" placeholder="그룹명 또는 그룹코드" />
						</div>
					</div>
				</div>
				<div class="find_btn">
		...
		<div class="grid_btn_set_top">
			<a href="member_group_write.php" class="btn">신규등록</a>
			<div class="right">
			</div>
		</div>
...
<script>
	MemberGroup.MemberGroupListInit();
</script>
