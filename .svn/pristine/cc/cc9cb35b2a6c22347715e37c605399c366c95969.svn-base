...
$_SESSION["XLS_PRODUCT_MONTHLY"] = "Y";

//기존 Grid List 불러오기 및 엑셀 출력용 변수 설정
$gridPrintForExcelDownload = true;
require "./product_monthly_grid.php";
...
$xls_header = array(
	array(
		"header_name" => "상품옵션코드",
		"field_name" => "product_option_idx2",
		"width" => 22,
	),
	array(
		"header_name" => "상품명",
...
//	array(
//		"header_name" => "판매가x수량",
//		"field_name" => "sum_settle_sale_supply2",
//		"width" => 20,
//		"data_type" => "number",
//		"halign" => "right",
//	),
	...
	array(
		"header_name" => "접수",
		"field_name" => "current_accept_count",
		"width" => 20,
		"data_type" => "number",
		"halign" => "right",
	),
	array(
		"header_name" => "송장",
		"field_name" => "current_invoice_count",
		"width" => 20,
		"data_type" => "number",
		"halign" => "right",
	),
	array(
		"header_name" => "기간내 발주수량",
		"field_name" => "accept_count",
		"width" => 20,
		"data_type" => "number",
		"halign" => "right",
	),
	array(
		"header_name" => "기간내 송장수량",
	...
	array(
		"header_name" => "기간내 배송수량",
		"field_name" => "shipping_count",
		"width" => 20,
		"data_type" => "number",
		"halign" => "right",
	),
...
//일자별 헤더 추가
foreach($_qry_date_ary as $d){
	$xls_header[] = array(
		"is_use" => 1,
		"field_name" => $d["colName"] . "_" . $_search_paramAryList["value_view"],
		"header_name" => $d["date"],
		"width" => 21,
		"data_type" => "number",
		"halign" => "right",
...
foreach($_list as $row_num => $row) {
	...
	$product_option_purchase_price = $row["product_option_purchase_price"];
	...
	foreach ($xls_row as $cellValue) {
		...
		if($field_name == "sum_product_option_purchase_price"){
			$cellValue = $product_option_purchase_price * $sum_product_option_cnt;
		}elseif($field_name == "sum_settle_sale_supply2"){
			$cellValue = $sum_settle_sale_supply * $sum_product_option_cnt;
		}
