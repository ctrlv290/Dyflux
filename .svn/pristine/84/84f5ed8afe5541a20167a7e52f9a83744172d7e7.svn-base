						...
						<div class="finder_set">
							...
							<div class="finder_col">
								<select name="search_column">
									<option value="stock_order_email_receiver" <?=($search_column == "stock_order_email_receiver") ? "selected" : ""?>>수신자</option>
...
<script>
	...
	StockOrder.StockOrderLogDownInit();
</script>
