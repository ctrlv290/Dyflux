...
$args['qry_table_name'] 	= " DY_ORDER_COLLECT OC 
 ...
 ";
$args['qry_where']			= " OC.order_collect_is_del = N'N' And A.seller_is_del = N'N' And (OC.collect_type = N'XLS' Or (OC.collect_type = N'AUTO' And OC.collect_state = N'S'))";
